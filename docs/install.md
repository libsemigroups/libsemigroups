...
To build `libsemigroups` from a release archive:
    ...
    curl -L -O https://github.com/libsemigroups/libsemigroups/releases/latest/download/libsemigroups-3.3.0.tar.gz
    tar -xf libsemigroups-3.3.0.tar.gz
    rm -f libsemigroups-3.3.0.tar.gz
    cd libsemigroups-3.3.0
