...
double spdotr2limited(const sparsematrix* s,
     ae_int_t r,
     ae_int_t nmax,
     ae_state *_state);
void spappendelementrow(sparsematrix* s,
     ae_int_t j,
     double v,
     ae_state *_state);
void spcrstraceenumerateonelinee6e15(const sparsematrix* s,
     ae_bool usee15,
     ae_bool newlineatend,
     ae_state *_state);
