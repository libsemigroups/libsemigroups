...
#define ALIGNED
#endif
#ifndef ALGLIB_UNUSED_STATIC_INLINE
    #if defined(__clang__)
         /*
          * Clang supports GNU __attribute__((__unused__)).
          * clang-cl may also define _MSC_VER, so handle Clang first.
          */
        #if defined(_MSC_VER)
        #define ALGLIB_UNUSED_STATIC_INLINE static __inline __attribute__((__unused__))
        #else
        #define ALGLIB_UNUSED_STATIC_INLINE static __inline__ __attribute__((__unused__))
        #endif
    #elif defined(__GNUC__)
         /*
          * GCC, including old C89/C++98 modes.
          */
        #define ALGLIB_UNUSED_STATIC_INLINE static __inline__ __attribute__((__unused__))
    #elif defined(_MSC_VER)
         /*
          * MSVC C and C++.
          * No old-MSVC portable equivalent of GNU unused.
          */
        #define ALGLIB_UNUSED_STATIC_INLINE static __inline
    #elif defined(__cplusplus)
         /*
          * Any standard C++ compiler.
          */
        #define ALGLIB_UNUSED_STATIC_INLINE static inline
    ...
    #else
         /*
          * Unknown strict C89 compiler: safest fallback.
          */
        #define ALGLIB_UNUSED_STATIC_INLINE static
    #endif
#endif
...
#error ALGLIB was requested to fail without FMA intrinsics
        #endif
    #endif
#elif defined(AE_CPU) && (AE_CPU==AE_ARM64)
    /*
     * AArch64 (ARM V8+) definitions
     */
    #if !defined(AE_NO_NEON)
        #include <arm_neon.h>
        #define _ALGLIB_HAS_NEON_INTRINSICS
        /*#if !defined(AE_NO_SVE)*/
    #endif
#elif defined(AE_CPU) && (AE_CPU==AE_RISCV64)
    /*
     * RISC-V RVV 1.0 definitions
     */
    #if !defined(AE_NO_RVV10)
        #define _ALGLIB_HAS_RVV10_INTRINSICS
    #endif
#endif
...
enum { DT_BOOL=1, DT_BYTE=1, DT_INT=2, DT_REAL=3, DT_COMPLEX=4, DT_UINT8=5, DT_UINT16=6, DT_UINT32=7, DT_UINT64=8 };
enum { CPU_INITIALIZED=0x1, CPU_SSE2=0x2, CPU_AVX2=0x4, CPU_FMA=0x8, CPU_NEON=0x10, CPU_RVV10=0x20 };
...
typedef struct
{
    ae_int64_t  requesttype;
    union { void *ptr; ae_int64_t portable_alignment_enforcer; } reportx;
    double      reportf;
    ae_int64_t  querysize;
    ae_int64_t  queryfuncs;
    ae_int64_t  queryvars;
    ae_int64_t  querydim;
    ae_int64_t  queryformulasize;
    union { void *ptr; ae_int64_t portable_alignment_enforcer; } querydata;
    union { void *ptr; ae_int64_t portable_alignment_enforcer; } replyfi;
    union { void *ptr; ae_int64_t portable_alignment_enforcer; } replydj;
    union { void *ptr; ae_int64_t portable_alignment_enforcer; } replysj;
} x_rcommv2;

typedef ae_int32_t (*ae_xcore_user_rcomm_handler)(x_rcommv2 *xrcv2, void *p0, void *p1, void *p2, ae_uint64_t flags, ae_uint64_t worker_idx);
...
typedef struct ae_vector
{
    ...
    /*
     * Either DT_BOOL/DT_BYTE, DT_INT, DT_REAL, DT_COMPLEX or DT_UINT*
     */
...
ALGLIB_UNUSED_STATIC_INLINE void ae_set_global_threading(ae_uint64_t flg_value) { ae_set_global_flags(flg_value); }
...
/************************************************************************
sparse matrix type is declared in aenv.h, because we need its definition
for rcommstate.
************************************************************************/
typedef struct
{
...
RComm functions
************************************************************************/
#define _ALGLIB_MAX_RCOMMV2_REQUEST 99
typedef struct rcommstate rcommstate;
typedef struct rcommstate
{
    ...
    /* rcomm handler */
    void (*rcomm2_handler)(rcommstate *state, void *p0, void *p1, void *p2, void *p3, ae_state *_state);
    void *handler_p0;
    void *handler_p1;
    void *handler_p2;
    void *handler_p3;
...
/********************************************************************
Handler used to pass data via X-interface
********************************************************************/
...
************************************************************************/
    ...
    #elif AE_CPU==AE_ARM64 && !defined(_ALGLIB_TSAN)
        #define _ALGLIB_ATOMIC_SAVE_FPTR(ptr_name, func_name) \
        { \
            if( (sizeof(ptr_name)!=sizeof(void*)) || (ae_misalignment(&ptr_name,sizeof(void*))!=0) ) \
                { fprintf(stderr, "ALGLIB: critical error during _ALGLIB_ATOMIC_SAVE_FPTR() for %s()\n", #ptr_name); fflush(stderr); abort(); }  \
    ...
    #elif AE_CPU==AE_RISCV64 && !defined(_ALGLIB_TSAN)
        #define _ALGLIB_ATOMIC_SAVE_FPTR(ptr_name, func_name) \
        { \
            if( (sizeof(ptr_name)!=sizeof(void*)) || (ae_misalignment(&ptr_name,sizeof(void*))!=0) ) \
                { fprintf(stderr, "ALGLIB: critical error during _ALGLIB_ATOMIC_SAVE_FPTR() for %s()\n", #ptr_name); fflush(stderr); abort(); }  \
     ...
     */
        ...
        #define _ALGLIB_KSV_VOID_SSE2(fname,params)   if( cached_cpuid&CPU_SSE2 ) { _ALGLIB_ATOMIC_SAVE_FPTR(fname, fname##_sse2); fname##_sse2 params; return; }
        #define _ALGLIB_KSV_RETURN_SSE2(fname,params) if( cached_cpuid&CPU_SSE2 ) { _ALGLIB_ATOMIC_SAVE_FPTR(fname, fname##_sse2); return fname##_sse2 params; }
    #else
        #define _ALGLIB_KKK_VOID_SSE2(fname,params)
        #define _ALGLIB_KKK_RETURN_SSE2(fname,params)
        #define _ALGLIB_KSV_VOID_SSE2(fname,params)
        #define _ALGLIB_KSV_RETURN_SSE2(fname,params)
    #endif
        ...
        #define _ALGLIB_KKK_VOID_NEON(fname,params)   if( cached_cpuid&CPU_NEON ) { fname##_neon params; return; }
        #define _ALGLIB_KKK_RETURN_NEON(fname,params) if( cached_cpuid&CPU_NEON ) { return fname##_neon params; }
        #define _ALGLIB_KSV_VOID_NEON(fname,params)   if( cached_cpuid&CPU_NEON ) { _ALGLIB_ATOMIC_SAVE_FPTR(fname, fname##_neon); fname##_neon params; return; }
        #define _ALGLIB_KSV_RETURN_NEON(fname,params) if( cached_cpuid&CPU_NEON ) { _ALGLIB_ATOMIC_SAVE_FPTR(fname, fname##_neon); return fname##_neon params; }
    #else
        #define _ALGLIB_KKK_VOID_NEON(fname,params)
        #define _ALGLIB_KKK_RETURN_NEON(fname,params)
        #define _ALGLIB_KSV_VOID_NEON(fname,params)
        #define _ALGLIB_KSV_RETURN_NEON(fname,params)
    #endif
    #if defined(_ALGLIB_HAS_RVV10_INTRINSICS)
        #define _ALGLIB_KSV_VOID_RVV10(fname,params)   if( cached_cpuid&CPU_RVV10 ) { _ALGLIB_ATOMIC_SAVE_FPTR(fname, fname##_rvv10); fname##_rvv10 params; return; }
        #define _ALGLIB_KSV_RETURN_RVV10(fname,params) if( cached_cpuid&CPU_RVV10 ) { _ALGLIB_ATOMIC_SAVE_FPTR(fname, fname##_rvv10); return fname##_rvv10 params; }
    #else
        #define _ALGLIB_KSV_VOID_RVV10(fname,params)
        #define _ALGLIB_KSV_RETURN_RVV10(fname,params)
    #endif
    ...
    #endif
    #if defined(_ALGLIB_HAS_SSE2_INTRINSICS) || defined(_ALGLIB_HAS_AVX2_INTRINSICS)
        #define _ALGLIB_KERNELSAVE_VOID_SSE2_AVX2(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            _ALGLIB_KSV_VOID_AVX2(fname,params)\
            _ALGLIB_KSV_VOID_SSE2(fname,params)\
        }
        #define _ALGLIB_KERNELSAVE_RETURN_SSE2_AVX2(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            _ALGLIB_KSV_RETURN_AVX2(fname,params)\
            _ALGLIB_KSV_RETURN_SSE2(fname,params)\
        }
    #else
        #define _ALGLIB_KERNELSAVE_VOID_SSE2_AVX2(fname,params)   {}
        #define _ALGLIB_KERNELSAVE_RETURN_SSE2_AVX2(fname,params) {}
    ...
    #endif
    #if defined(_ALGLIB_HAS_SSE2_INTRINSICS) || defined(_ALGLIB_HAS_AVX2_INTRINSICS) || defined(_ALGLIB_HAS_FMA_INTRINSICS)
        #define _ALGLIB_KERNELSAVE_VOID_SSE2_AVX2_FMA(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
        ...
        #define _ALGLIB_KERNELSAVE_RETURN_SSE2_AVX2_FMA(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
        ...
        #define _ALGLIB_KERNELSAVE_VOID_AVX2(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            _ALGLIB_KSV_VOID_AVX2(fname,params)\
        }
        #define _ALGLIB_KERNELSAVE_RETURN_AVX2(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            _ALGLIB_KSV_RETURN_AVX2(fname,params)\
        }
    ...
    #if defined(_ALGLIB_HAS_NEON_INTRINSICS)
        #define _ALGLIB_KERNEL_VOID_NEON(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            _ALGLIB_KKK_VOID_NEON(fname,params)\
        }
        #define _ALGLIB_KERNEL_RETURN_NEON(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            _ALGLIB_KKK_RETURN_NEON(fname,params)\
        }
        #define _ALGLIB_KERNELSAVE_VOID_NEON(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            _ALGLIB_KSV_VOID_NEON(fname,params)\
        }
        #define _ALGLIB_KERNELSAVE_RETURN_NEON(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            _ALGLIB_KSV_RETURN_NEON(fname,params)\
        }
    #else
        #define _ALGLIB_KERNEL_VOID_NEON(fname,params) {}
        #define _ALGLIB_KERNEL_RETURN_NEON(fname,params) {}
    ...
    #if defined(_ALGLIB_HAS_RVV10_INTRINSICS)
        #define _ALGLIB_KERNELSAVE_VOID_RVV10(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            _ALGLIB_KSV_VOID_RVV10(fname,params)\
        }
        #define _ALGLIB_KERNELSAVE_RETURN_RVV10(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            _ALGLIB_KSV_RETURN_RVV10(fname,params)\
        }
    #else
        #define _ALGLIB_KERNELSAVE_VOID_RVV10(fname,params) {}
        #define _ALGLIB_KERNELSAVE_RETURN_RVV10(fname,params) {}
...
/************************************************************************
Inlineable implementations for the highest performance
************************************************************************/
ALGLIB_UNUSED_STATIC_INLINE ae_uint64_t ae_bitwise_real_to_uint64(double v, ae_state *state)
{
    ae_uint64_t r;
    memcpy(&r, &v, sizeof(r));
    return r;
...
ALGLIB_UNUSED_STATIC_INLINE double ae_bitwise_uint64_to_real(ae_uint64_t v, ae_state *state)
{
    double r;
    memcpy(&r, &v, sizeof(r));
    return r;
...
public:
    ...
    rcommv2_buffers(const rcommstate *state);
...
public:
    ...
    void    (*rep)(const alglib::real_1d_array &x, double func, void *ptr);
...
public:
    ...
    // This constructor guarantees that no dynamic allocations needing non-trivial destruction will be performed.
    //
    rcommv2_request(rcommstate *_s, void   *_ptr, const char *_sp):subpackage(_sp),ptr(_ptr),rcommv2(_s)
    {
        memset(&request_lock, 0, sizeof(request_lock));
        ae_init_lock(&request_lock, NULL, ae_false);
    }
    ...
    rcommv2_request(ae_int_t &_rq,
                    ...
                    double  &_repf,
                    void   *_ptr,
                    const char *_sp):subpackage(_sp),ptr(_ptr),query_data(_qd),request(_rq),size(_sz),funcs(_fn),vars(_vc),dim(_di),formulasize(_fs),reply_fi(_rf),reply_dj(_rj),reply_sj(rs),reportx(_repx),reportf(_repf)
                    {
                        memset(&request_lock, 0, sizeof(request_lock));
                        ae_init_lock(&request_lock, NULL, ae_false);
                    }*/
    ...
    //
    // Destructor. The only function is to free lock memory.
    //
    ~rcommv2_request()
    {
        ae_free_lock(&request_lock);
    }
    ...
    //
    // This function may propagate exceptions arising in user callbacks or re-throw them as an instance of alglib::ap_error.
    //
    void process_standard(rcommstate *state, rcommv2_callbacks &callbacks, rcommv2_buffers &buffers, ae_state *_state);
};

void rcommv2_request_cpphandler(rcommstate *state, void *p0, void *p1, void *p2, void *p3, ae_state *_state);
void process_v2request_1(rcommv2_request &request, rcommstate *state, ae_int_t query_idx, rcommv2_callbacks &callbacks, rcommv2_buffers &buffers, rcommv2_request::query_order order, alglib_impl::sparsematrix *dst_jacobian);
void process_v2request_2(rcommv2_request &request, rcommstate *state, ae_int_t query_idx, rcommv2_callbacks &callbacks, rcommv2_buffers &buffers);
void process_v2request_3phase0(rcommv2_request &request, rcommstate *state, ae_int_t job_idx, rcommv2_callbacks &callbacks, rcommv2_buffers &buffers);
void process_v2request_3phase1(rcommv2_request &request, rcommstate *state);
void process_v2request_4(rcommv2_request &request, rcommstate *state, ae_int_t query_idx, rcommv2_callbacks &callbacks, rcommv2_buffers &buffers);
void process_v2request_5phase0(rcommv2_request &request, rcommstate *state, ae_int_t job_idx, rcommv2_callbacks &callbacks, rcommv2_buffers &buffers);
void process_v2request_5phase1(rcommv2_request &request, rcommstate *state);
 ...
 * ABLASF kernels
 */
extern double (*rdotv)(ae_int_t n,
     /* Real    */ const ae_vector* x,
     /* Real    */ const ae_vector* y,
     ae_state *_state);
extern double (*rdotvr)(ae_int_t n,
     /* Real    */ const ae_vector* x,
     /* Real    */ const ae_matrix* a,
     ae_int_t i,
     ae_state *_state);
extern double (*rdotrr)(ae_int_t n,
     /* Real    */ const ae_matrix* a,
     ae_int_t ia,
     /* Real    */ const ae_matrix* b,
     ae_int_t ib,
     ae_state *_state);
extern double (*rdotv2)(ae_int_t n,
     /* Real    */ const ae_vector* x,
     ae_state *_state);
extern void (*rcopyv)(ae_int_t n,
     /* Real    */ const ae_vector* x,
     /* Real    */ ae_vector* y,
     ae_state *_state);
extern void (*rcopyvr)(ae_int_t n,
     /* Real    */ const ae_vector* x,
     /* Real    */ ae_matrix* a,
     ae_int_t i,
     ae_state *_state);
extern void (*rcopyrv)(ae_int_t n,
     /* Real    */ const ae_matrix* a,
     ae_int_t i,
     /* Real    */ ae_vector* x,
     ae_state *_state);
extern void (*rcopyrr)(ae_int_t n,
     /* Real    */ const ae_matrix* a,
     ae_int_t i,
     /* Real    */ ae_matrix* b,
     ae_int_t k,
     ae_state *_state);
extern void (*rcopymulv)(ae_int_t n,
     double v,
     /* Real    */ const ae_vector* x,
     /* Real    */ ae_vector* y,
     ae_state *_state);
extern void (*rcopyrcpv)(ae_int_t n,
     /* Real    */ const ae_vector* x,
     /* Real    */ ae_vector* y,
     ae_state *_state);
extern void (*rcopymulvr)(ae_int_t n,
     double v,
     /* Real    */ const ae_vector* x,
     /* Real    */ ae_matrix* y,
     ae_int_t ridx,
     ae_state *_state);
extern void (*icopyv)(ae_int_t n,
     /* Integer */ const ae_vector* x,
     /* Integer */ ae_vector* y,
     ae_state *_state);
extern void (*bcopyv)(ae_int_t n,
     /* Boolean */ const ae_vector* x,
     /* Boolean */ ae_vector* y,
     ae_state *_state);
extern void (*rsetv)(ae_int_t n,
     double v,
     /* Real    */ ae_vector* x,
     ae_state *_state);
extern void (*rsetr)(ae_int_t n,
     double v,
     /* Real    */ ae_matrix* a,
     ae_int_t i,
     ae_state *_state);
extern void (*rsetvx)(ae_int_t n,
     double v,
     /* Real    */ ae_vector* x,
     ae_int_t offsx,
     ae_state *_state);
void rsetm(ae_int_t m,
     ...
     /* Real    */ ae_matrix* a,
     ae_state *_state);
extern void (*isetv)(ae_int_t n,
     ae_int_t v,
     /* Integer */ ae_vector* x,
     ae_state *_state);
extern void (*bsetv)(ae_int_t n,
     ae_bool v,
     /* Boolean */ ae_vector* x,
     ae_state *_state);
extern void (*rmulv)(ae_int_t n,
     double v,
     /* Real    */ ae_vector* x,
     ae_state *_state);
extern void (*rmulr)(ae_int_t n,
     double v,
     /* Real    */ ae_matrix* x,
     ae_int_t rowidx,
     ae_state *_state);
extern void (*rsqrtv)(ae_int_t n,
     /* Real    */ ae_vector* x,
     ae_state *_state);
extern void (*rsqrtr)(ae_int_t n,
     /* Real    */ ae_matrix* x,
     ae_int_t rowidx,
     ae_state *_state);
extern void (*rmulvx)(ae_int_t n,
     double v,
     /* Real    */ ae_vector* x,
     ae_int_t offsx,
     ae_state *_state);
extern void (*raddv)(ae_int_t n,
     double alpha,
     /* Real    */ const ae_vector* y,
     /* Real    */ ae_vector* x,
     ae_state *_state);
extern void (*raddvr)(ae_int_t n,
     double alpha,
     /* Real    */ const ae_vector* y,
     /* Real    */ ae_matrix* x,
     ae_int_t rowidx,
     ae_state *_state);
extern void (*raddrv)(ae_int_t n,
     double alpha,
     /* Real    */ const ae_matrix* y,
     ae_int_t ridx,
     /* Real    */ ae_vector* x,
     ae_state *_state);
extern void (*raddrr)(ae_int_t n,
     double alpha,
     /* Real    */ const ae_matrix* y,
     ae_int_t ridxsrc,
     /* Real    */ ae_matrix* x,
...
extern void (*raddvx)(ae_int_t n,
     ...
     ae_int_t offsx,
     ae_state *_state);
extern void (*rmuladdv)(ae_int_t n,
     /* Real    */ const ae_vector* y,
     /* Real    */ const ae_vector* z,
     /* Real    */ ae_vector* x,
     ae_state *_state);
extern void (*rmuladdvx)(ae_int_t n,
     /* Real    */ const ae_vector* y,
     ae_int_t offsy,
     /* Real    */ const ae_vector* z,
     ae_int_t offsz,
     ...
     ae_int_t offsx,
     ae_state *_state);
extern void (*rnegmuladdv)(ae_int_t n,
     /* Real    */ const ae_vector* y,
     /* Real    */ const ae_vector* z,
     /* Real    */ ae_vector* x,
     ae_state *_state);
extern void (*rnegmuladdvx)(ae_int_t n,
     /* Real    */ const ae_vector* y,
     ae_int_t offsy,
     /* Real    */ const ae_vector* z,
     ae_int_t offsz,
     ...
     ae_int_t offsx,
     ae_state *_state);
extern void (*rcopymuladdv)(ae_int_t n,
     /* Real    */ const ae_vector* y,
     /* Real    */ const ae_vector* z,
     /* Real    */ const ae_vector* x,
     /* Real    */ ae_vector* r,
     ae_state *_state);
extern void (*rcopymuladdvx)(ae_int_t n,
     /* Real    */ const ae_vector* y,
     ae_int_t offsy,
     /* Real    */ const ae_vector* z,
     ae_int_t offsz,
     ...
     ae_int_t offsr,
     ae_state *_state);
extern void (*rcopynegmuladdv)(ae_int_t n,
     /* Real    */ const ae_vector* y,
     /* Real    */ const ae_vector* z,
     /* Real    */ const ae_vector* x,
     /* Real    */ ae_vector* r,
     ae_state *_state);
extern void (*rcopynegmuladdvx)(ae_int_t n,
     /* Real    */ const ae_vector* y,
     ae_int_t offsy,
     /* Real    */ const ae_vector* z,
     ae_int_t offsz,
     ...
     ae_int_t offsr,
     ae_state *_state);
extern void (*rmergemulv)(ae_int_t n,
     /* Real    */ const ae_vector* y,
     /* Real    */ ae_vector* x,
     ae_state *_state);
extern void (*rmergemulvx)(ae_int_t n,
     /* Real    */ const ae_vector* y,
     ae_int_t offsy,
     /* Real    */ ae_vector* x,
     ae_int_t offsx,
     ae_state *_state);
extern void (*rmergemulvr)(ae_int_t n,
     /* Real    */ const ae_vector* y,
     /* Real    */ ae_matrix* x,
     ae_int_t rowidx,
     ae_state *_state);
extern void (*rmergemulrv)(ae_int_t n,
     /* Real    */ const ae_matrix* y,
     ae_int_t rowidx,
     /* Real    */ ae_vector* x,
     ae_state *_state);
extern void (*rmergedivv)(ae_int_t n,
     /* Real    */ const ae_vector* y,
     /* Real    */ ae_vector* x,
     ae_state *_state);
extern void (*rmergedivvr)(ae_int_t n,
     /* Real    */ const ae_vector* y,
     /* Real    */ ae_matrix* x,
     ae_int_t rowidx,
     ae_state *_state);
extern void (*rmergedivrv)(ae_int_t n,
     /* Real    */ const ae_matrix* y,
     ae_int_t rowidx,
     /* Real    */ ae_vector* x,
     ae_state *_state);
extern void (*rmergemaxv)(ae_int_t n,
     /* Real    */ const ae_vector* y,
     /* Real    */ ae_vector* x,
     ae_state *_state);
extern void (*rmergemaxvr)(ae_int_t n,
     /* Real    */ const ae_vector* y,
     /* Real    */ ae_matrix* x,
     ae_int_t rowidx,
     ae_state *_state);
extern void (*rmergemaxrv)(ae_int_t n,
     /* Real    */ const ae_matrix* y,
     ae_int_t rowidx,
     /* Real    */ ae_vector* x,
     ae_state *_state);
extern void (*rmergeminv)(ae_int_t n,
     /* Real    */ const ae_vector* y,
     /* Real    */ ae_vector* x,
     ae_state *_state);
extern void (*rmergeminvr)(ae_int_t n,
     /* Real    */ const ae_vector* y,
     /* Real    */ ae_matrix* x,
     ae_int_t rowidx,
     ae_state *_state);
extern void (*rmergeminrv)(ae_int_t n,
     /* Real    */ const ae_matrix* y,
     ae_int_t rowidx,
     /* Real    */ ae_vector* x,
     ae_state *_state);
extern double (*rmaxv)(ae_int_t n,
    /* Real    */ const ae_vector* x,
    ae_state *_state);
extern double (*rmaxr)(ae_int_t n,
     /* Real    */ const ae_matrix* x,
     ae_int_t rowidx,
     ae_state *_state);
extern double (*rmaxabsv)(ae_int_t n,
     /* Real    */ const ae_vector* x,
     ae_state *_state);
extern double (*rmaxabsr)(ae_int_t n,
     /* Real    */ const ae_matrix* x,
     ae_int_t rowidx,
     ae_state *_state);
extern void (*rcopyvx)(ae_int_t n,
     /* Real    */ const ae_vector* x,
     ae_int_t offsx,
     /* Real    */ ae_vector* y,
     ae_int_t offsy,
     ae_state *_state);
extern void (*rcopyrcpvx)(ae_int_t n,
     /* Real    */ const ae_vector* x,
     ae_int_t offsx,
     /* Real    */ ae_vector* y,
     ae_int_t offsy,
     ae_state *_state);
extern void (*icopyvx)(ae_int_t n,
     /* Integer */ const ae_vector* x,
     ae_int_t offsx,
     /* Integer */ ae_vector* y,
     ae_int_t offsy,
