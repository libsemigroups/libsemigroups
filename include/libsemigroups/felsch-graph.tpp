...
namespace libsemigroups {
  ...
  template <typename Word, typename Node, typename Definitions>
  FelschGraph<Word, Node, Definitions>::FelschGraph(Presentation<Word> const& p)
      : FelschGraph() {
    init(p);
  }
  ...
  template <typename Word, typename Node, typename Definitions>
  void
  FelschGraph<Word, Node, Definitions>::reduce_number_of_edges_to(size_type n) {
  ...
  bool FelschGraph<Word, Node, Definitions>::merge_targets_of_nodes_if_possible(
      node_type      x,
      label_type     a,
      node_type      y,
      label_type     b,
  ...
  template <typename Word, typename Node, typename Definitions>
  bool FelschGraph<Word, Node, Definitions>::process_definitions(size_t start) {
