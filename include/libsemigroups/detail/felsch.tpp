...
namespace libsemigroups {
  namespace detail {
    ...
    Felsch<Graph, Definitions>::Felsch()
        : _felsch_tree(0),
    ...
    template <typename Graph, typename Definitions>
    Felsch<Graph, Definitions>& Felsch<Graph, Definitions>::init() {
      FelschSettings_::init();
      // Mutable
      _felsch_tree.init(0);
      _felsch_tree_initted = false;
    ...
    template <typename Graph, typename Definitions>
    Felsch<Graph, Definitions>::Felsch(Felsch const&) = default;

    template <typename Graph, typename Definitions>
    Felsch<Graph, Definitions>::Felsch(Felsch&&) = default;

    template <typename Graph, typename Definitions>
    Felsch<Graph, Definitions>&
    Felsch<Graph, Definitions>::operator=(Felsch const&)
        = default;

    template <typename Graph, typename Definitions>
    Felsch<Graph, Definitions>& Felsch<Graph, Definitions>::operator=(Felsch&&)
        = default;

    template <typename Graph, typename Definitions>
    Felsch<Graph, Definitions>::Felsch(Presentation<Word> const& p) : Felsch() {
      init(p);
    }

    template <typename Graph, typename Definitions>
    Felsch<Graph, Definitions>&
    Felsch<Graph, Definitions>::init(Graph const&              wg,
      ...
      if (c > out_degree()) {
        ...
        Graph::add_to_out_degree(c - out_degree());
      }
      _felsch_tree.init(c);
      _felsch_tree_initted = false;
      return *this;
    ...
    template <typename Graph, typename Definitions>
    Felsch<Graph, Definitions>::~Felsch() = default;

    ////////////////////////////////////////////////////////////////////////
    // Felsch - operators - public
    ////////////////////////////////////////////////////////////////////////

    template <typename Graph, typename Definitions>
    bool Felsch<Graph, Definitions>::operator==(Felsch const& that) const {
    ...
    template <typename Graph, typename Definitions>
    Presentation<Word>& Felsch<Graph, Definitions>::presentation() noexcept {
    ...
    Felsch<Graph, Definitions>::presentation() const noexcept {
      return _presentation;
    }
    ...
    void Felsch<Graph, Definitions>::add_definition(node_type  s,
                                                    label_type a,
    ...
    template <typename Graph, typename Definitions>
    void Felsch<Graph, Definitions>::reduce_number_of_edges_to(size_type n) {
      LIBSEMIGROUPS_ASSERT(Graph::number_of_edges() == _definitions.size());
    ...
    template <typename Graph, typename Definitions>
    template <bool RegisterDefs, typename Incompatible, typename PreferredDefs>
    bool Felsch<Graph, Definitions>::merge_targets_of_nodes_if_possible(
        node_type      x,
        label_type     a,
        node_type      y,
        label_type     b,
      ...
      node_type xa = (a == UNDEFINED ? x : Graph::target_no_checks(x, a));
      node_type yb = (b == UNDEFINED ? y : Graph::target_no_checks(y, b));

      if (xa == UNDEFINED && yb != UNDEFINED) {
        LIBSEMIGROUPS_ASSERT(a < out_degree());
        target_no_checks<RegisterDefs>(x, a, yb);
      } else if (xa != UNDEFINED && yb == UNDEFINED) {
        LIBSEMIGROUPS_ASSERT(b < out_degree());
        target_no_checks<RegisterDefs>(y, b, xa);
    ...
    template <typename Graph, typename Definitions>
    template <bool RegisterDefs, typename Incompatible, typename PreferredDefs>
    bool Felsch<Graph, Definitions>::merge_targets_of_paths_if_possible(
        node_type                          u_node,
    ...
    bool
    Felsch<Graph, Definitions>::process_definitions(size_t         start,
                                                    Incompatible&  incompat,
    ...
    template <typename Graph, typename Definitions>
    bool Felsch<Graph, Definitions>::process_definitions(size_t start) {
    ...
    template <typename Graph, typename Definitions>
    Felsch<Graph, Definitions>&
    Felsch<Graph, Definitions>::private_init_from_presentation() {
    ...
    template <typename Graph, typename Definitions>
    Felsch<Graph, Definitions>&
    Felsch<Graph, Definitions>::private_init_from_word_graph() {
      ...
      for (auto n : Graph::nodes()) {
        for (auto e : Graph::labels()) {
          if (Graph::target_no_checks(n, e) != UNDEFINED) {
    ...
    template <typename Graph, typename Definitions>
    void Felsch<Graph, Definitions>::init_felsch_tree() const {
    ...
    template <typename Graph, typename Definitions>
    template <bool RegisterDefs, typename Incompatible, typename PreferredDefs>
    inline bool Felsch<Graph, Definitions>::
      ...
      return merge_targets_of_paths_if_possible<RegisterDefs>(
          c,
    ...
    template <typename Graph, typename Definitions>
    template <typename Incompatible, typename PreferredDefs>
    bool Felsch<Graph, Definitions>::process_definition_v2(
        Definition     d,
        Incompatible&  incompat,
        PreferredDefs& pref_defs) {
      ...
      for (auto it = felsch_tree().cbegin(); it < felsch_tree().cend(); ++it) {
        ...
        if (!merge_targets_of_paths_labelled_by_rules_if_possible<
                REGISTER_DEFS_YES>(d.first, *it, incompat, pref_defs)) {
          return false;
        }
      }
    ...
    template <typename Graph, typename Definitions>
    template <typename Incompatible, typename PreferredDefs>
    bool Felsch<Graph, Definitions>::process_definition_v1(
        Definition     d,
        Incompatible&  incompat,
        PreferredDefs& pref_defs) {
      felsch_tree().push_back(d.second);
    ...
    template <typename Graph, typename Definitions>
    template <typename Incompatible, typename PreferredDefs>
    bool Felsch<Graph, Definitions>::process_definitions_v2(
        size_t         start,
        Incompatible&  incompat,
        PreferredDefs& pref_defs) {
    ...
    template <typename Graph, typename Definitions>
    template <typename Incompatible, typename PreferredDefs>
    bool Felsch<Graph, Definitions>::process_definitions_v1(
        size_t         start,
        Incompatible&  incompat,
        PreferredDefs& pref_defs) {
      for (size_t i = start; i < _definitions.size(); ++i) {
    ...
    template <typename Graph, typename Definitions>
    template <typename Incompatible, typename PreferredDefs>
    bool Felsch<Graph, Definitions>::process_definitions_dfs_v2(
        node_type      root,
        node_type      c,
        Incompatible&  incompat,
        PreferredDefs& pref_defs) {
      ...
      for (size_t x = 0; x < n; ++x) {
        ...
        if (e != UNDEFINED && felsch_tree().push_front(x)) {
          ...
          for (auto it = felsch_tree().cbegin(); it < felsch_tree().cend();
            ...
            while (e != UNDEFINED) {
              if (!merge_targets_of_paths_if_possible<REGISTER_DEFS_YES>(
                      y,
                      u_first,
                      u_last,
                      e,
    ...
    template <typename Graph, typename Definitions>
    template <typename Incompatible, typename PreferredDefs>
    bool Felsch<Graph, Definitions>::process_definitions_dfs_v1(
        node_type      c,
        Incompatible&  incompat,
        PreferredDefs& pref_defs) {
      for (auto it = felsch_tree().cbegin(); it < felsch_tree().cend(); ++it) {
        if (!merge_targets_of_paths_labelled_by_rules_if_possible<
                REGISTER_DEFS_YES>(c, *it, incompat, pref_defs)) {
          return false;
        }
      }
    ...
    namespace felsch {
      template <bool RegisterDefs,
                ...
                typename PrefDefs>
      bool
      make_compatible(Felsch<Graph, Definitions>&                    fd,
                      typename Felsch<Graph, Definitions>::node_type first_node,
                      typename Felsch<Graph, Definitions>::node_type last_node,
        ...
        for (Node n = first_node; n < last_node; ++n) {
          for (auto it = first_rule; it != last_rule; it += 2) {
            if (!fd.template merge_targets_of_paths_if_possible<RegisterDefs,
                                                                Incompatible,
                                                                PrefDefs>(
                    n,
                    it->cbegin(),
