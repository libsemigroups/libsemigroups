...
namespace libsemigroups {
  ...
  namespace fpsemigroup {
    ...
    //! various semigroups and monoids, usually accompanied by a reference to a
    //! the source of the presentation. There may be several presentations for
    //! any semigroup or monoid.
    //!
    //! For each semigroup or monoid, there is a corresponding default function
    //! that is documented in the \ref default_presentations_member_group
    //! "Default presentations" section.
    //!
    ///@{
    ...
    //! Renner monoid of type B with size \p l and Iwahori-Hecke deformation
    //! \p q.
    //!
    ...
    //!
    //! This functions returns a presentation that incorrectly claims to be the
    //! Renner monoid of type D with size \p l and Iwahori-Hecke deformation
    //! \p q.
    //!
