...
namespace libsemigroups {
  ...
  //! \f$f: \{a, \ldots, b - 1\} \to \{0, \ldots, n - 1\}\f$ so that
  //! \f$(x)f\f$ equals the target of the edge starting at node \f$x\f$ with
  //! label \f$n\f$. In this way, every edge label in a WordGraph
  //! corresponds to a transformation of the nodes of the digraph. If
  //! \f$\{a, \ldots, b - 1\}f
  //! \subseteq \{a, \ldots, b - 1\}\f$, then \f$f\f$ is a transformation in
  //! the sense of Transf. Assuming that for every edge label of the
  //! WordGraph the corresponding \f$f\f$ satisfies \f$\{a, \ldots, b - 1\}f
  //! \subseteq
  //! \{a, \ldots, b - 1\}\f$, then this function returns the FroidurePin
  //! object corresponding to the semigroup generated by the set of all such
  //! transformations.
  //!
