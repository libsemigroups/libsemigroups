...
#ifndef LIBSEMIGROUPS_INCLUDE_TIMER_HPP_
#define LIBSEMIGROUPS_INCLUDE_TIMER_HPP_
    ...
    class Timer {
     ...
     private:
      ...
      static bool string_it(std::string&              str,
        ...
        if (x > T(threshold)) {
          str += internal::to_string(x.count()) + unit;
          elapsed -= x;
          return true;
        }
        return false;
...
#endif  // LIBSEMIGROUPS_INCLUDE_TIMER_HPP_
