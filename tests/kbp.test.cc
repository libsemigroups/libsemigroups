...
TEST_CASE("KBP 01: for an infinite fp semigroup",
  ...
  REQUIRE(*(ntc->at(0, 0)) == word_type({0}));
  delete ntc;
}
...
TEST_CASE("KBP 03: for an infinite fp semigroup",
  ...
  std::vector<relation_type> rels
      = {relation_type({0, 1}, {0}), relation_type({1, 0}, {0}),
         relation_type({0, 2}, {0}), relation_type({2, 0}, {0}),
         relation_type({0, 3}, {0}), relation_type({3, 0}, {0}),
         relation_type({0, 0}, {0}), relation_type({1, 1}, {0}),
         relation_type({2, 2}, {0}), relation_type({3, 3}, {0}),
         relation_type({1, 2}, {0}), relation_type({2, 1}, {0}),
         relation_type({1, 3}, {0}), relation_type({3, 1}, {0}),
         relation_type({2, 3}, {0}), relation_type({3, 2}, {0}),
         relation_type({4, 0}, {0}), relation_type({4, 1}, {1}),
         relation_type({4, 2}, {2}), relation_type({4, 3}, {3}),
         relation_type({0, 4}, {0}), relation_type({1, 4}, {1}),
         relation_type({2, 4}, {2}), relation_type({3, 4}, {3})};
  std::vector<relation_type> extra = {{{1}, {2}}};
...
TEST_CASE("KBP 04: for an infinite fp semigroup",
  ...
  std::vector<relation_type> rels
      = {relation_type({0, 1}, {0}), relation_type({1, 0}, {0}),
         ...
         relation_type({1, 3}, {0}), relation_type({3, 1}, {0}),
         relation_type({2, 3}, {0}), relation_type({3, 2}, {0}),
         relation_type({4, 0}, {0}), relation_type({4, 1}, {2}),
         relation_type({4, 2}, {3}), relation_type({4, 3}, {1}),
         relation_type({0, 4}, {0}), relation_type({1, 4}, {2}),
         relation_type({2, 4}, {3}), relation_type({3, 4}, {1})};
  std::vector<relation_type> extra = {{{2}, {3}}};
  Congruence                 cong("twosided", 5, rels, extra);
  cong.force_kbp();
  REPORTER.set_report(KBP_REPORT);
...
TEST_CASE("KBP 05: trivial congruence on a finite fp semigroup",
  ...
  std::vector<relation_type> rels
      = {relation_type({0, 0, 1}, {0, 0}),
         relation_type({0, 0, 0, 0}, {0, 0}),
         relation_type({0, 1, 1, 0}, {0, 0}),
         relation_type({0, 1, 1, 1}, {0, 0, 0}),
         relation_type({1, 1, 1, 0}, {1, 1, 0}),
         relation_type({1, 1, 1, 1}, {1, 1, 1}),
         relation_type({0, 1, 0, 0, 0}, {0, 1, 0, 1}),
         relation_type({0, 1, 0, 1, 0}, {0, 1, 0, 0}),
         relation_type({0, 1, 0, 1, 1}, {0, 1, 0, 1})};
...
TEST_CASE("KBP 06: universal congruence on a finite fp semigroup",
  ...
  std::vector<relation_type> rels
      = {relation_type({0, 0, 1}, {0, 0}),
         ...
         relation_type({0, 1, 0, 1, 1}, {0, 1, 0, 1})};
  std::vector<relation_type> extra
      = {relation_type({0}, {1}), relation_type({0, 0}, {0})};
  Congruence cong("twosided", 2, rels, extra);
  cong.force_kbp();
  REPORTER.set_report(KBP_REPORT);
