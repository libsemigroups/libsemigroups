...
namespace libsemigroups {
  ...
  //      REQUIRE(
  //          std::distance(kb.cbegin_normal_forms(0, 7),
  //          kb.cend_normal_forms())
  //          == 155577);
  //      REQUIRE(
  //          std::vector<std::string>(
  //              {"",   "a",  "A",  "c",  "C",  "b",  "B",  "d",  "D",  "aa",
  //              "ac",
  //               "aC", "ab", "aB", "ad", "aD", "AA", "Ac", "AC", "Ab", "AB",
  //               "Ad", "AD", "ca", "cA", "cc", "cb", "cB", "cd", "cD", "Ca",
  //               "CA", "CC", "Cb", "CB", "Cd", "CD", "ba", "bA", "bc", "bC",
  //               "bb", "bd", "bD", "Ba", "BA", "Bc", "BC", "BB", "Bd", "BD",
  //               "da", "dA", "dc", "dC", "db", "dB", "dd", "Da", "DA", "Dc",
  //               "DC", "Db", "DB", "DD"})
  ...
  //                                          kb.cend_normal_forms()));
  //      REQUIRE(
  //          std::distance(kb.cbegin_normal_forms(0, 5),
  //          kb.cend_normal_forms())
  //          == 161);
  //    }
  //
  ...
  //               {"aaa", "y"}, {"aac", "by"}, {"bbb", "yd"}, {"bby",
  //               "aad"}}));
  //    }
  //
  //    // Von Dyck (2,3,7) group - infinite hyperbolic - small tidyint works
  //    better LIBSEMIGROUPS_TEST_CASE("KnuthBendix",
  //                            "032",
  ...
  //                                       kb.cend_normal_forms())
  //              == std::vector<std::string>({"a", "b", "aa", "ab", "ba",
  //              "bb"}));
  //    }
  //
  //    LIBSEMIGROUPS_TEST_CASE("KnuthBendix", "047", "code coverage",
  //    "[quick]") {
  //      KnuthBendix kb1;
  //      KnuthBendix kb2(kb1);
  //      REQUIRE(kb1.size() == 0);
  ...
  //      REQUIRE(kb.confluent());
  //      REQUIRE(kb.normal_form("CBACBAABCAABCACBACBA") ==
  //      "CBACBACBAACBAACBACBA"); REQUIRE(kb.equal_to("CBAABCABCAABCAABCABC",
  //      "CBACBAABCAABCACBACBA")); REQUIRE(kb.equal_to("CBAABCABCAABCAABCABC",
  ...
  //      //                                cend_silo("BCA", 5, 6))
  //      //         == std::vector<std::string>());
  //      // REQUIRE(number_of_words(3, 20, 21) ==
  //      size_t(18446744071562067968ULL));
  //
