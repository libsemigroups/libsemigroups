...
#include "libsemigroups/words.hpp"        // for Words
...
namespace libsemigroups {
  ...
  LIBSEMIGROUPS_TEST_CASE("SuffixTree",
    ...
    REQUIRE(t.is_subword(004000_w));
    REQUIRE(t.is_subword(04_w));
    REQUIRE(!t.is_subword(44_w));
    REQUIRE(t.is_subword({}));
    REQUIRE(t.is_subword(0_w));
    REQUIRE(t.is_subword(00_w));
    REQUIRE(t.is_subword(000_w));
    REQUIRE(t.is_subword(000_w));
    REQUIRE(!t.is_subword(0000_w));
    REQUIRE(!t.is_subword(1_w));
    REQUIRE(t.number_of_subwords() == 16);

    Words words;
    words.letters(6).min(0).max(8);
    REQUIRE((words | rx::filter([&t](auto const& w) { return t.is_subword(w); })
             | rx::count())
            == 16);

    REQUIRE(t.is_subword({}));  // 1
    REQUIRE(t.is_subword(004000_w));
    REQUIRE(t.is_subword(00400_w));
    REQUIRE(t.is_subword(0040_w));
    REQUIRE(t.is_subword(004_w));  // 5
    REQUIRE(t.is_subword(00_w));
    REQUIRE(t.is_subword(0_w));
    REQUIRE(t.is_subword(04000_w));
    REQUIRE(t.is_subword(0400_w));
    REQUIRE(t.is_subword(040_w));  // 10
    REQUIRE(t.is_subword(04_w));
    REQUIRE(t.is_subword(4000_w));
    REQUIRE(t.is_subword(400_w));
    REQUIRE(t.is_subword(40_w));
    REQUIRE(t.is_subword(4_w));    // 15
    REQUIRE(t.is_subword(000_w));  // 16
    ...
    REQUIRE(t.is_subword(01_w));
    REQUIRE(t.is_subword(012_w));
    REQUIRE(t.is_subword(0123_w));
    REQUIRE(t.is_subword(1_w));
    REQUIRE(t.is_subword(12_w));
    REQUIRE(t.is_subword(123_w));
    REQUIRE(t.is_subword(2_w));
    REQUIRE(t.is_subword(23_w));
    REQUIRE(t.is_subword(3_w));

    REQUIRE(!t.is_subword(33_w));
    REQUIRE(t.number_of_subwords() == 25);

    REQUIRE(!t.is_suffix(1235_w));
    REQUIRE(t.is_suffix(123_w));

    REQUIRE(t.is_suffix({}));
    REQUIRE(t.is_suffix(004000_w));
    REQUIRE(t.is_suffix(04000_w));
    REQUIRE(t.is_suffix(4000_w));
    REQUIRE(t.is_suffix(000_w));
    REQUIRE(t.is_suffix(00_w));
    REQUIRE(t.is_suffix(0_w));
    REQUIRE(t.is_suffix(0123_w));
    REQUIRE(t.is_suffix(123_w));
    REQUIRE(t.is_suffix(23_w));
    REQUIRE(t.is_suffix(3_w));

    words.letters(5).min(0).max(7);
    REQUIRE((words | rx::filter([&t](auto const& w) { return t.is_suffix(w); })
             | rx::count())
            == 11);

    REQUIRE(t.maximal_piece_prefix(004000_w) == 2);
    REQUIRE(t.maximal_piece_prefix(0123_w) == 1);
  }
  ...
  LIBSEMIGROUPS_TEST_CASE("SuffixTree",
    ...
    REQUIRE(t.is_subword(1_w));
    REQUIRE(t.is_subword(2_w));
    REQUIRE(t.is_subword(4_w));
    REQUIRE(t.is_subword(01_w));
    REQUIRE(t.is_subword(12_w));
    REQUIRE(t.is_subword(24_w));
    REQUIRE(t.is_subword(012_w));
    REQUIRE(t.is_subword(124_w));
    ...
    REQUIRE(t.is_suffix({}));
    REQUIRE(!t.is_suffix(0_w));
    REQUIRE(!t.is_suffix(1_w));
    REQUIRE(t.is_suffix(2_w));
    REQUIRE(t.is_suffix(4_w));
    REQUIRE(!t.is_suffix(01_w));
    REQUIRE(t.is_suffix(12_w));
    REQUIRE(t.is_suffix(24_w));
    REQUIRE(t.is_suffix(012_w));
    REQUIRE(t.is_suffix(124_w));
    REQUIRE_THROWS_AS(t.is_suffix({static_cast<size_t>(-1), 1, 2, 4}),
                      LibsemigroupsException);

    REQUIRE(t.maximal_piece_prefix(012_w) == 0);
    REQUIRE(t.maximal_piece_prefix(124_w) == 2);
    REQUIRE(t.maximal_piece_suffix(012_w) == 2);
    REQUIRE(t.maximal_piece_suffix(124_w) == 0);

    REQUIRE(t.number_of_pieces(012_w) == POSITIVE_INFINITY);
    REQUIRE(t.number_of_pieces(124_w) == POSITIVE_INFINITY);
  }
