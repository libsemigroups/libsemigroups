...
namespace libsemigroups {
  ...
  //     LIBSEMIGROUPS_TEST_CASE("KnuthBendix",
  //                             "052",
  //                             "(fpsemi) Chapter 8, Theorem 4.2 in NR
  //                             (infinite)",
  //                             "[knuth-bendix][fpsemigroup][fpsemi][quick]") {
  //       auto        rg = ReportGuard(REPORT);
  //       KnuthBendix kb;
  ...
  //       REQUIRE(
  //           std::distance(kb.cbegin_normal_forms(0, 6),
  //           kb.cend_normal_forms())
  //           == 62);
  //       Strings s;
  ...
  //       for: KnuthBendix kb; kb.set_alphabet("abcdefghij");
  //
  //       kb.add_rule("afh", "bgh");
  //       kb.add_rule("hc", "de");
  //       kb.add_rule("ei", "j");
  ...
  //       which
  //       // the max piece suffixes of the first two relation words no longer
  //       agree
  ...
  //       REQUIRE(kb.size() == POSITIVE_INFINITY);
  //       REQUIRE(kb.active_rules() == std::vector<rule_type>({{"aabc",
  //       "acba"}})); REQUIRE(kb.number_of_normal_forms(0, 6) == 356);
  //     }
  //
  //     LIBSEMIGROUPS_TEST_CASE(
  //         "KnuthBendix",
  ...
  //     }
  //
  //     // 2-generator free abelian group (with this ordering KB terminates -
  //     but
  //     // no all)
  //     LIBSEMIGROUPS_TEST_CASE(
  //         "KnuthBendix",
  ...
  //       REQUIRE(kb.rewrite("aabbbbbbbbbbbba") ==
  //       kb.rewrite("bbbbbbbbbbbba")); REQUIRE(kb.rewrite("babbbbbbbbbbaa") ==
  //       kb.rewrite("babbbbbbbbbb")); REQUIRE(kb.rewrite("baabbbbbbbbaa") ==
  //       kb.rewrite("baabbbbbbbb"));
  //       REQUIRE(kb.rewrite("bbbbbbbbaabbbbbbbbaa") ==
  //       kb.rewrite("bbbbbbbbaa")); REQUIRE(kb.rewrite("bbbaa") ==
  //       kb.rewrite("baabb")); REQUIRE(kb.rewrite("abbbbbaabbbbba") ==
  //       kb.rewrite("bbbbbbbbaa"));
  //
  ...
  //               == 11);
  //       REQUIRE(
  //           std::vector<std::string>(kb.cbegin_normal_forms(0,
  //           POSITIVE_INFINITY),
  //                                    kb.cend_normal_forms())
  //           == std::vector<std::string>(
  //               {"a", "b", "c", "d", "e", "aa", "ac", "ad", "bb", "be",
  //               "aad"}));
  //     }
  //
  //     LIBSEMIGROUPS_TEST_CASE("KnuthBendix",
  //                             "074",
  //                             "(fpsemi) F(2, 6) - Chapter 9, Section 1 in
  //                             NR",
  //                             "[knuth-bendix][fpsemigroup][fpsemi][quick]") {
  //       auto        rg = ReportGuard(REPORT);
  //       KnuthBendix kb;
  ...
  //     LIBSEMIGROUPS_TEST_CASE("KnuthBendix",
  //                             "075",
  //                             "(fpsemi) Chapter 10, Section 4 in NR
  //                             (infinite)",
  //                             "[knuth-bendix][fpsemigroup][fpsemi][quick]") {
  //       auto        rg = ReportGuard(REPORT);
  //       KnuthBendix kb;
  ...
  //     }
  //
  //     // Note: the fourth relator in NR's thesis incorrectly has exponent 3,
  //     it
  //     // should be 2. With exponent 3, the presentation defines the trivial
  //     // group, with exponent of 2, it defines the symmetric group as
  //     desired. LIBSEMIGROUPS_TEST_CASE("KnuthBendix",
  //                             "076",
  ...
  //           == std::vector<std::string>(
  //               {"",    "a",   "b",   "A",   "B",   "aa",  "ab",  "aB", "ba",
  //                "bb",  "bA",  "Ab",  "AA",  "AB",  "Ba",  "BA",  "aaa",
  //                "aab", "aaB", "aba", "abb", "abA", "aBa", "aBA", "baa",
  //                "bab", "baB", "bbA", "bAA", "Aba", "AAb", "AAA", "AAB",
  //                "ABa", "Baa", "BAA"}));
  //     }
  //
  //     LIBSEMIGROUPS_TEST_CASE("KnuthBendix",
  ...
  //       REQUIRE(
  //           std::distance(kb.cbegin_normal_forms(0, 10),
  //           kb.cend_normal_forms())
  //           == 55);
  //       REQUIRE(
  //           std::vector<std::string>(kb.cbegin_normal_forms(0, 4),
  //                                    kb.cend_normal_forms())
  //           == std::vector<std::string>(
  //               {"", "a", "b", "aa", "ba", "bb", "aaa", "baa", "bba",
  //               "bbb"}));
  //     }
  //
  //     LIBSEMIGROUPS_TEST_CASE("KnuthBendix",
  //                             "079",
  //                             "(fpsemi) plactic monoid of degree 2
  //                             (infinite)",
  //                             "[knuth-bendix][fpsemigroup][fpsemi][quick]") {
  //       auto        rg = ReportGuard(REPORT);
  //       KnuthBendix kb;
  ...
  //           std::vector<std::string>(kb.cbegin_normal_forms(0, 4),
  //                                    kb.cend_normal_forms())
  //           == std::vector<std::string>({"a", "b", "ab", "ba", "aba",
  //           "bab"}));
  //     }
  //
  //     LIBSEMIGROUPS_TEST_CASE("KnuthBendix",
  //                             "081",
  //                             "(fpsemi) Chapter 7, Theorem 3.6 in NR (size
  //                             243)",
  //                             "[knuth-bendix][fpsemigroup][fpsemi][quick]") {
  //       auto        rg = ReportGuard(REPORT);
  //       KnuthBendix kb;
  ...
  //         "KnuthBendix",
  //         "998",
  //         "Giles Gardam in \"A counterexample to the unit conjecture for
  //         group " "rings\" (https://arxiv.org/abs/2102.11818)",
  //         "[fpsemigroup][fail]") {
  //       KnuthBendix k;
