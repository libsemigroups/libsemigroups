...
std::vector<ActionDigraph<TIntType>>
make_sample(size_t nr, size_t nr_nodes, size_t nr_edges) {
  std::mt19937                         mt;
...
LIBSEMIGROUPS_BENCHMARKS() {
  ...
  LIBSEMIGROUPS_BENCHMARK(
      ...
      ->Unit(benchmark::kMicrosecond);
  LIBSEMIGROUPS_BENCHMARK(
      "ActionDigraph<size_t>::spanning_forest() 10 disjoint cycles of length 10",
      spanning_forest,
      sample_cycles_10_10_size_t)
      ->Unit(benchmark::kMicrosecond);
  LIBSEMIGROUPS_BENCHMARK(
      "ActionDigraph<size_t>::spanning_forest() 100 disjoint cycles of length 10",
      spanning_forest,
      sample_cycles_100_10_size_t)
      ->Unit(benchmark::kMicrosecond);
  LIBSEMIGROUPS_BENCHMARK(
      "ActionDigraph<size_t>::spanning_forest() 1000 disjoint cycles of length 10",
      spanning_forest,
      sample_cycles_1000_10_size_t)
      ->Unit(benchmark::kMicrosecond);
  return 0;
