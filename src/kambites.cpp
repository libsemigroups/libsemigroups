...
namespace libsemigroups {
  ...
  namespace congruence {
    ...
    //         add_pair(k.string_to_word(it->first),
    //         k.string_to_word(it->second));
    //       }
    //     }
    //
    ...
    //     }
    //
    //     class_index_type Kambites::word_to_class_index_impl(word_type const&
    //     word) {
    //       auto   S   =
    //       static_cast<froidure_pin_type*>(_k->froidure_pin().get()); size_t
    //       pos = S->position(detail::KE(*_k, word)); LIBSEMIGROUPS_ASSERT(pos
    //       != UNDEFINED); return pos;
    //     }
    //
