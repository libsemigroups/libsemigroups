...
#if !defined(LIBSEMIGROUPS_SYSTEM_MALLOC) && !defined(__CYGWIN__) \
...
// This file provides overrides for the standard library malloc style entry
// points
...
static int pthread_create_proxy(pthread_t*            thread,
...
int pthread_create(pthread_t*            thread,
  ...
  return (
      *(int (*)(pthread_t*, const pthread_attr_t*, void* (*) (void*), void*))
          real_pthread_create)(thread, attr, thread_starter, starter_arg);
}
...
#else
void make_the_compiler_happy(int x) {
  (void) x;
}
#endif
